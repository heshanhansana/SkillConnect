...
mongoose
    ...
    .catch((err) => {
        ...
        console.error("ℹ️ If using mongodb+srv, ensure SRV DNS resolves: 'nslookup -type=SRV _mongodb._tcp.<cluster>.mongodb.net' and your IP is allowed in Atlas Network Access.");
    });
